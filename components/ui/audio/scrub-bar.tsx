...
function ScrubBarTrack({ className, children, ...props }: ScrubBarTrackProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "bg-secondary/70 relative h-2 w-full grow cursor-pointer touch-none rounded-full transition-none select-none",
        className
      )}
...
function ScrubBarProgress({ className, ...props }: ScrubBarProgressProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "bg-primary absolute h-full rounded-full transition-none",
        className
      )}
...
function ScrubBarThumb({ className, children, ...props }: ScrubBarThumbProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "bg-primary shadow-sm absolute top-1/2 block h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full transition-colors disabled:pointer-events-none disabled:opacity-50",
        className
      )}
      style={{ left: `${progress}%` }}
      {...props}
