...
export const baseUIMigrationOrder = [
  {
    ...
    priority: 1,
    consumers: ["button (animated + static)", "sidebar", "popover (static)"],
    notes: "Simplest — Slot is a utility, Base UI has direct equivalent",
    baseUIPackage: "@base-ui-components/react/slot",
  },
  {
    package: "@radix-ui/react-separator",
    priority: 2,
    consumers: ["separator"],
    notes: "Simple — could be replaced with pure CSS <hr> if needed",
    baseUIPackage: "@base-ui-components/react/separator",
  },
  {
    package: "@radix-ui/react-avatar",
    priority: 3,
    consumers: ["avatar"],
    notes: "Direct Base UI equivalent exists",
    baseUIPackage: "@base-ui-components/react/avatar",
  },
  {
    ...
    consumers: ["tooltip"],
    notes: "Direct Base UI equivalent exists",
    baseUIPackage: "@base-ui-components/react/tooltip",
  },
  {
    package: "@radix-ui/react-scroll-area",
    priority: 5,
    consumers: ["scroll-area"],
    notes: "Moderate complexity — custom scrollbar behavior",
    baseUIPackage: "@base-ui-components/react/scroll-area",
  },
  {
    package: "@radix-ui/react-slider",
    priority: 5,
    consumers: ["slider"],
    notes: "Moderate complexity — multi-thumb support",
    baseUIPackage: "@base-ui-components/react/slider",
  },
  {
    package: "@radix-ui/react-dialog",
    priority: 6,
    consumers: ["sheet (animated + static)"],
    notes: "Complex — Sheet uses Dialog primitive with side variants",
    baseUIPackage: "@base-ui-components/react/dialog",
  },
  {
    package: "@radix-ui/react-dropdown-menu",
    priority: 7,
    consumers: ["dropdown-menu"],
    notes: "Most complex — nested menus, keyboard nav, submenus",
    baseUIPackage: "@base-ui-components/react/menu",
  },
  {
    package: null,
    priority: 0,
    consumers: ["alert-dialog (animated + static)", "popover (animated)"],
    notes: "Already custom implementations — no Radix dependency to migrate",
    baseUIPackage: null,
  },
] as const;
