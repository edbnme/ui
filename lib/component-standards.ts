...
export const baseUIMigrationOrder = [
  {
    ...
    consumers: [
      ...
      "dialog", "dropdown-menu", "field", "form", "input", "number-field",
      "popover", "preview-card", "progress", "radio-group", "scroll-area",
      "select", "separator", "sheet", "slider", "switch", "tabs", "toast",
      "toggle", "toggle-group", "toolbar", "tooltip",
    ],
    notes: "Primary headless primitive provider — all static components use Base UI",
  },
  {
